...
@section('content')
<div class="jumbotron">
    <h1 ><a href="/admin/quanlyhusband" style="color:black;text-decoration: none"> Quản lý người chồng</a>/ <a href=""  style="color:black;text-decoration: none">Sửa thông tin</a></h1>
